      ...
      <nav>
        <div className="hidden sm:flex items-center justify-around shadow-md">
          ...
          <ul className="flex items-center lg:gap-12 gap-8 text-sm font-bold tracking-wide">
            <Link
              onClick={() => navigateToProducts("menClothes")}
              to="/products"
            >
              <li className="hover:text-gray-600">MEN</li>
            </Link>
            <Link
              onClick={() => navigateToProducts("womenClothes")}
              to="/products"
            >
            ...
            <Link
              ...
              to="/products"
            >
              <li className="hover:text-gray-600">ELECTRONICS</li>
            </Link>
            <Link onClick={() => navigateToProducts("Footwear")} to="/products">
              <li className="hover:text-gray-600">FOOTWEAR</li>
            </Link>
          </ul>
                    ...
                    <div className="border-b pb-4">
                      {currentUser ? (
                        <>
                          ...
                          <p className="text-sm mt-1">{currentUser.user.email}</p>
                          <button
        ...
        <div className="sm:hidden">
          ...
          >
            <div className="shadow-b py-6 shadow-sm bg-pink-50 flex flex-col justify-center gap-4 text-sm font-bold text-black tracking-wide">
              ...
              <Link
                onClick={() => {
                  navigateToProducts("womenClothes");
                  toggleMenu();
                }}
                to="/products"
              >
